...
const UserData = ({ user }) => {
  ...
  const options = [
    ...
    { icon: <ListAltIcon />, name: "Orders", func: orders },
    {
      icon: (
        <ShoppingCartIcon
          style={{
            color: cartItems.length > 0 ? "tomato" : "gray",
          }}
        />
      ),
    ...
    },
    {
      icon: (
        <HeartIcon
          style={{
            color: favouriteItems.length > 0 ? "tomato" : "gray",
          }}
        />
      ),
    ...
    { icon: <Settings />, name: "Settings", func: report },
  ...
  return (
    <>
      <Backdrop open={open} style={{ zIndex: 10, backgroundColor: "rgba(0,0,0,0.5)" }} />
      <SpeedDial
